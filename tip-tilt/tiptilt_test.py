...
def filter_tiptilt(N, total_time=0.1):
    ...
    filter = TipTilt(measurement_noise_single_axis)
    #filter.R = filter.R * 5 # measurement noise model: make this larger and you trust the dynamic model more.
