...
freqs = np.linspace(0, f//2, f//2+1) # equivalent to signal.periodogram(...)[0]
...
get_psd = lambda pos: signal.periodogram(pos, f_sampling)[1]
...
def reconstruct_modes(times, signal, N):
